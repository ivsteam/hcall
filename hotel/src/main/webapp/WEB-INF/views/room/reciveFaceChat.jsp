		...
		<div class="container" >
			<div class="col-md-5">
				...
				<!-- <div class="" style="display:none;"> -->
					<div class="col-md-6">
						<input id="name" name="name" class="" type="hidden"   value="호텔프론트" onkeydown="if (event.keyCode == 13) register();"/>
					<!-- </div>
					<div class="col-md-6 text-right"> -->
						<!-- <a id="register" href="#" class="btn btn-primary">
						<span class="glyphicon glyphicon-plus"></span> 대화명</a>
					</div> -->
				</div>
				...
				<div class="">
					<div class="col-md-6">
						<input id="peer" name="peer" class="" type="text" value="${roomInfoVo.room_create_id }" onkeydown="if (event.keyCode == 13) call();">
				<!-- 	</div>
					<div class="col-md-6 text-right"> -->
						<a id="call" href="#" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Call</a> 
