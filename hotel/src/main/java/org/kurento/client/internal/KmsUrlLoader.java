...
public class KmsUrlLoader extends UrlServiceLoader<KmsProvider> {
	...
	public static final String DEFAULT_KMS_URL = "ws://52.231.31.104:8888/kurento";
	...
	private synchronized String loadKmsUrlFromProvider(String id, int loadPoints) {
		...
		if (loadPoints == -1) {
			...
			log.debug("Executed reserveKms({},{}) in serviceProvider with result={}", id, loadPoints, kmsUrl);
			return kmsUrl;
		}
	}
