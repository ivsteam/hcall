...
//    개발용
//    	Paths.get(StandardSystemProperty.USER_DIR.value(), "src/main/resources", "config.properties");
//      배포
    	Paths.get( "/tmp/src/main/resources/", "config.properties");
      System.out.println("1============"+ StandardSystemProperty.USER_DIR.value());
      System.out.println("1============"+ StandardSystemProperty.USER_HOME.value());
