 ...
 * @since 4.3.1
 */
public class FaceChatUserSession {

  private static final Logger log = LoggerFactory.getLogger(FaceChatUserSession.class);
  ...
  public FaceChatUserSession(WebSocketSession session, String name) {
