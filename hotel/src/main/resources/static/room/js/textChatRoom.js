...
function pubFaceHide( txtData , msgJson, baseData, sendLanguage, receiveLanguage){
	...
	/*<li class='u_chat'><div class='u_face'></div><div class='u_chat_text'><p class='u_t_text'>요청드릴게 있는데요.</p></div></li>
		
	<li class='m_chat'><div class='m_chat_text'>
			<p class='m_t_text'>네. 고객님 말씀하세요.</p>
			<p class='m_t_clock'>7:01pm</p></div></li>
	*/
	...
	if( tmpMessage.name == document.getElementById("name").value ){
		...
		/*document.getElementById("textMessageChannel").innerHTML += "<p class=\"red\">&nbsp;&nbsp;"+baseData +"<br></p>" ;	*/
document.getElementById("textMessageChannel").innerHTML += 	"<li class='u_chat'><div class='u_face'></div>" +
																						"<p class='u_t_room'>"+document.getElementById("name").value +"</p>" +
																						"<div class='u_chat_text'><p class='u_t_text'>"+baseData +"</p></div></li>"	;

	
	
	}else{
		/*document.getElementById("textMessageChannel").innerHTML += "<p class=\"blue\">["+tmpMessage.name + "]<br></p>" ;
		document.getElementById("textMessageChannel").innerHTML += "<p class=\"blue\">&nbsp;&nbsp;"+ txtData +"<br></p>" ;*/
		
		document.getElementById("textMessageChannel").innerHTML += 	"<li class='m_chat'><div class='m_chat_text'>" +
																								"<p class='u_t_room'>"+tmpMessage.name +"</p>" +
																								"<p class='m_t_text'>"+ txtData +"</p>" +
																								"";
	}
	
	document.getElementById("dataChannelSend").value = " ";
	
	document.getElementById('textMessageChannel').scrollTop = document.getElementById('textMessageChannel').scrollHeight;
